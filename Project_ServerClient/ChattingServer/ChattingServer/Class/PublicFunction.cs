...
namespace ChattingServer
{
    ...
    public class PublicFunction
    {
        ...
        /* 클라이언트의 IP를 얻는 함수 */
        public string GetClientIP(Socket client)
        {
            IPEndPoint ip_point = (IPEndPoint)client.RemoteEndPoint;
            return ip_point.Address.ToString();
        }
        ...
        public string Get_External_Host_IP()
        {
            ...
            try
            {
                /// [http://checkip.dyndns.org/]에서 외부IP를 가져온다.
                /// Html을 IP 부분만을 SubString하여 반환한다.
