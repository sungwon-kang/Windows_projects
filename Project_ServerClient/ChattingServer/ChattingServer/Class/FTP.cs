...
namespace ChattingServer
{
    public class FTP
    {
        ...
        public void FtpStart(string FilePath)
        {
            ...
            pf.printLog($"FtpStart() -> Try connecting to Send files to recipients");
        }
        // start Server - > Ans 1 Client ->  Ans 2 Server
        // Wait true ,      work true    (Wait false, work true)
            ...
            switch (Data.Sigl)
            {
                ...
                case 2:
                    ...
                    if (Data.FileLength == FileLength && Data.FileName == FileName)
                    {
                        ...
                        client.Send(FTP_SendBuff, FTP_SendBuff.Length, SocketFlags.None);
                    }
                    break;
            }
        }
        ...
        public Packet FileSend(Packet Data)
        {
            ...
            Data.Sender = "Server";
            Data.Receiver = pf.GetClientIP(client);
        ...
        public Packet FileRecv(Packet Data)
        {
            if (FileName == Data.FileName)
            {
                ...
                pf.printLog($"FileRecv() -> Received {Buff_Length_Total} of {FileLength}");
            }
            else
            {
        ...
        public void FileClose()
        {
            ...
            MainWindow.btn_Send_File.Dispatcher.Invoke(System.Windows.Threading.DispatcherPriority.Normal, new Action(delegate ()
            {
                MainWindow.btn_Send_File.IsEnabled = true;
            }));
        }
    }
}
